...
namespace Question20
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter the index that you want to remove from the list :");
            var remove_char = Convert.ToInt32(Console.ReadLine());

            listOfString.RemoveAt(remove_char);
